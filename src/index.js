...
//const serverUrl = NODE_ENV === 'development' ? 'http://praktikum.tk/cohort3' : 'https://95.216.175.5/cohort3';
...
class Api{
  ...
  */
  getInitialCards(){
    ...
    fetch('http://praktikum.tk/cohort3/cards',{
      method:'GET',
      headers: {
  ...
  getProfile(){
    fetch('http://praktikum.tk/cohort3/users/me',{
      method:'GET',
      headers: {
        authorization: keyAuthorization}
    })
